...
export const contractAmendments = mysqlTable("contract_amendments", {
  ...
  description: text("description"),
  valueChange: decimal("valueChange", { precision: 15, scale: 2 }),
  newTotalValue: decimal("newTotalValue", { precision: 15, scale: 2 }),
...
export const financialMilestones = mysqlTable("financial_milestones", {
  ...
  title: varchar("title", { length: 255 }).notNull(),
  description: text("description"),
  plannedValue: decimal("plannedValue", { precision: 15, scale: 2 }).notNull(),
  paidValue: decimal("paidValue", { precision: 15, scale: 2 }),
